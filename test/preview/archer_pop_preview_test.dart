...
void main() {
  test('render archer pop preview', () async {
    ...
    final g = ArcherPop()..init(ctx);
    for (var i = 0; i < 130; i++) {
      g.update(1 / 60); // ~2.2s of action — bows drawn, arrows + balloons live
    }
    ...
    File('preview/archer_pop.png')
      ..createSync(recursive: true)
      ..writeAsBytesSync(png!.buffer.asUint8List());
    expect(File('preview/archer_pop.png').existsSync(), isTrue);
  });
}
