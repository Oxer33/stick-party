...
void main() {
  test('render falling_dodge preview', () async {
    ...
    for (var i = 0; i < 160; i++) { g.update(1 / 60); }
    ...
    File('preview/falling_dodge.png')..createSync(recursive: true)..writeAsBytesSync(png!.buffer.asUint8List());
    expect(File('preview/falling_dodge.png').existsSync(), isTrue);
  });
}
