...
void main() {
  test('render tank_duel preview', () async {
    ...
    for (var i = 0; i < 150; i++) { g.update(1 / 60); }
    ...
    File('preview/tank_duel.png')..createSync(recursive: true)..writeAsBytesSync(png!.buffer.asUint8List());
    expect(File('preview/tank_duel.png').existsSync(), isTrue);
  });
}
