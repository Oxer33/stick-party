...
void main() {
  test('render bumper balls preview', () async {
    ...
    File('preview/bumper_balls.png')..createSync(recursive: true)..writeAsBytesSync(png!.buffer.asUint8List());
    expect(File('preview/bumper_balls.png').existsSync(), isTrue);
  });
}
