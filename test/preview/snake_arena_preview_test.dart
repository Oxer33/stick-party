...
void main() {
  test('render snake arena preview', () async {
    ...
    for (var i = 0; i < 130; i++) {
      g.update(1 / 60); // ~2.2s of action — snakes grown, food + trails on show
    }
    ...
    File('preview/snake_arena.png')
      ..createSync(recursive: true)
      ..writeAsBytesSync(png!.buffer.asUint8List());
    expect(File('preview/snake_arena.png').existsSync(), isTrue);
  });
}
