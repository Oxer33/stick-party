...
void main() {
  test('render soccer preview (vertical N/S pitch)', () async {
    ...
    File('preview/one_touch_soccer.png')..createSync(recursive: true)..writeAsBytesSync(png!.buffer.asUint8List());
    expect(File('preview/one_touch_soccer.png').existsSync(), isTrue);
  });
}
